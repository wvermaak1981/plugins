...
final class WPFI_Feed_Repository {
 ...
 public function defaults(){return ['id'=>'','name'=>'','slug'=>'','url'=>'','enabled'=>1,'frequency'=>'daily','product_xpath'=>'/products/product','variation_xpath'=>'','identifier_field'=>'sku','variation_identifier_field'=>'sku','map'=>[],'attributes'=>[],'namespaces'=>[],'auth'=>['type'=>'none','api_key_name'=>'X-API-Key','api_key'=>'','bearer_token'=>'','username'=>'','password'=>'','query_params'=>[],'headers'=>[]]];}
}
