 ...
 * Description: Scheduled XML product imports with multiple feeds, custom mappings, namespaces, variable products, attributes, and an import log.
 * Version: 3.0.0
